    ...
    <div class="card-body">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="specialization" class="form-control" id="teacherSpecializationInput" value="<?= $teacher['specialization'] ?? '' ?>">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary" name="teach_update">Submit</button>
        </form>
    </div>
</div>
